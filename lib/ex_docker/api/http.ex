defmodule ExDocker.Api.HTTP do
  ...
  @doc """
  GET
        iex> ExDocker.Api.HTTP.get("http://httpbin.org/get")
  ...
  * opts must be a map
        ...
        iex> ExDocker.Api.HTTP.get("http://httpbin.org/get", %{foo: 1})
             {:ok, %{body: "foo", headers: _, status_code: 200} }
  """
  ...
  * payload is sent as JSON
        ...
        iex> ExDocker.Api.HTTP.post("http://httpbin.org/get", %{foo: 1})
             {:ok, %{body: "foo", headers: _, status_code: 200} }
  """
